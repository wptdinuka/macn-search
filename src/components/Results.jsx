...
export const Results = () => {
  ...
  switch (location.pathname) {
    ...
    case '/home':
        return (
          <div className="h-96 sm:px-56 flex flex-wrap justify-center content-center space-y-6">
            <h1 className="sm:text-base md:text-7xl font-semibold ">
          Welcome to <a className='text-blue-500' >MacnSearch</a>
        </h1>
              </div>
            );
